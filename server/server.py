...
def predict(url):
    ...
    column_names = [ 'port', 'non_standard_port', 'url_length', 'num_dots', 'special_chars_present', 'ip_used']
...
if __name__ == "__main__":
    ...
    try:
        ...
        response = {key: str(value) if isinstance(value, bool) else value for key, value in result.items()}
